...
const styles = StyleSheet.create({
    ...
    // container2: {   backgroundColor: 'black',   height: 400,   width: 300,
    // justifyContent: 'center',   alignItems: 'center', }, heading: {   fontSize:
    // 72,   paddingTop: 48,   margin: 48,   fontWeight: 'bold',   textAlign:
    // 'center',   color: 'white', },
